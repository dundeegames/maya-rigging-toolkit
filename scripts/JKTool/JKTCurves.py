...
def chinShape(shapeName):
	"""
	Creates Chin Shape"""
	chinCurve = mc.curve(name=shapeName, p=[(-3.064, 1.727, 0.65), (-4.415, 1.349, 3.057), (-3.224, 3.391, 4.757), (-0.258, 4.033, 6.105), (2.729, 3.324, 4.838), (4.003, 1.256, 3.172), (2.888, 1.661, 0.731), (0.024, 1.882, -2.272)],d=3)
